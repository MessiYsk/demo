/*
package com.example.demo.nio.nio2.b;
...
class FileAttributesExample {
    ...
    private static void fileSpaceAttributesExample(Path attribPath) throws Exception {
        ...
        for (FileStore fileStore : FileSystems.getDefault().getFileStores()) {
            ...
            FileStoreSpaceAttributeView spaceView = fileStore
    ...
    private static void userAttributesExample(Path attribPath) throws Exception {
        ...
        if (attribList.size() == 0) {
            ...
            System.out
                .println("ERROR: The file " + attribPath + " has some user defined attributes that were not expected");
        }
        ...
        if (attribList.size() == 1) {
            ...
            System.out.println("ERROR: The file " + attribPath + " has " + attribList.size()
                + " user defined attribute(s), but we expected 1!");
        }
        ...
        attribList = userView.list();
        if (attribList.size() == 0) {
            System.out.println("After deleting the attribute, the file " + attribPath
                + " has no user defined attributes left, as expected");
        } else {
            System.out
                .println("ERROR: The file " + attribPath + " has some user defined attributes that were not expected");
        }
